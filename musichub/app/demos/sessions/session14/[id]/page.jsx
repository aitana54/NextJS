...
export default async function SongDetailPage({ params }) {
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-8">
      ...
      <div className="mt-6 aspect-video overflow-hidden rounded-xl border shadow-sm grid place-items-center">
        <div className="text-center">
          <p className="text-sm text-gray-400">
            Reproductor disponible próximamente
          </p>
          <a
            className="mt-3 inline-flex items-center rounded-xl border border-[#F50057] bg-[#F50057] px-4 py-2 text-white transition hover:opacity-90"
            href={youtubeUrl}
            target="_blank"
            rel="noreferrer"
          >
